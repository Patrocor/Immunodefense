/** Captura Linfocito γδ v2 — Triδa cazadora + Cascada IL-17. DISPLAY=:1 node scripts/playtest-linfocitogd.mjs */
...
console.log("Linfocito γδ v2 triδa:", info);
await sleep(500);
await page.screenshot({ path: join(ART, "linfocitogd_v1_hunter_field.png") });
if (info.ok) {
  await page.screenshot({ path: join(ART, "linfocitogd_v2_delta_ultimate.png"), clip: info.clip });
}
