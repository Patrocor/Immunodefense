...
copyFileSync(join(TMP, "clo_wall.png"), join(ART, "clostridium_v4d_jaws_wall.png"));
copyFileSync(join(TMP, "clo_bare.png"), join(ART, "clostridium_v4d_jaws_bare.png"));
copyFileSync(join(TMP, "clo_field.png"), join(ART, "clostridium_v4d_jaws_field.png"));
