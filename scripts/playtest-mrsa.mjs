...
copyFileSync(join(TMP, "mrsa_cap.png"), join(ART, "mrsa_v1_carbuncle_cap.png"));
copyFileSync(join(TMP, "mrsa_bare.png"), join(ART, "mrsa_v1_carbuncle_bare.png"));
copyFileSync(join(TMP, "mrsa_field.png"), join(ART, "mrsa_v1_carbuncle_field.png"));
