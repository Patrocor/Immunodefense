...
copyFileSync(join(TMP, "mrsa_cap.png"), join(ART, "mrsa_v4_long_cap.png"));
copyFileSync(join(TMP, "mrsa_bare.png"), join(ART, "mrsa_v4_long_bare.png"));
copyFileSync(join(TMP, "mrsa_field.png"), join(ART, "mrsa_v4_long_field.png"));
