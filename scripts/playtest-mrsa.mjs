...
copyFileSync(join(TMP, "mrsa_cap.png"), join(ART, "mrsa_v3_grape_cap.png"));
copyFileSync(join(TMP, "mrsa_bare.png"), join(ART, "mrsa_v3_grape_bare.png"));
copyFileSync(join(TMP, "mrsa_field.png"), join(ART, "mrsa_v3_grape_field.png"));
