...
copyFileSync(join(TMP, "clo_wall.png"), join(ART, "clostridium_v4_beast_wall.png"));
copyFileSync(join(TMP, "clo_bare.png"), join(ART, "clostridium_v4_beast_bare.png"));
copyFileSync(join(TMP, "clo_field.png"), join(ART, "clostridium_v4_beast_field.png"));
